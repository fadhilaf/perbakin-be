...
type Querier interface {
	...
	// (admin-super role)
	GetResultsByExamId(ctx context.Context, id pgtype.UUID) ([]GetResultsByExamIdRow, error)
	// (all role)
	GetResultsByScorerId(ctx context.Context, scorerID pgtype.UUID) ([]GetResultsByScorerIdRow, error)
	...
	GetStage0Series1(ctx context.Context, id pgtype.UUID) (string, error)
	GetStage0Series2(ctx context.Context, id pgtype.UUID) (string, error)
	GetStage0Series3(ctx context.Context, id pgtype.UUID) (string, error)
	GetStage0Series4(ctx context.Context, id pgtype.UUID) (string, error)
	GetStage0Series5(ctx context.Context, id pgtype.UUID) (string, error)
	...
	GetSuperById(ctx context.Context, id pgtype.UUID) (GetSuperByIdRow, error)
