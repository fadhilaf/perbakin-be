...
func (app *App) initDelivery() {
	...
	deliveries.super = superDelivery.NewSuperDelivery(app.usecase.super, app.usecase.all)
	deliveries.admin = adminDelivery.NewAdminDelivery(app.usecase.admin, app.usecase.all)
