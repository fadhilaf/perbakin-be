		...
		stage2Response = gin.H{
			"stage_2": model.Stage2Full{
				...
				Try1: model.Stage2Try{
					...
					No1:        util.Stage123DatabaseNumbersToStruct(stage2.Try1No1),
					No2:        util.Stage123DatabaseNumbersToStruct(stage2.Try1No2),
					No3:        util.Stage123DatabaseNumbersToStruct(stage2.Try1No3),
				...
				Try2: model.Stage2Try{
					...
					No1:        util.Stage123DatabaseNumbersToStruct(stage2.Try2No1.String),
					No2:        util.Stage123DatabaseNumbersToStruct(stage2.Try2No2.String),
					No3:        util.Stage123DatabaseNumbersToStruct(stage2.Try2No3.String),
