...
func (usecase *adminSuperUsecaseImpl) UpdateStage3try2(req model.UpdateStage13try2Request) model.WebServiceResponse {
	newStage3, err := usecase.Store.UpdateStage3try2(context.Background(), repositoryModel.UpdateStage3try2Params{
		ID:             req.ID,
	...
	return util.ToWebServiceResponse("Berhasil mengubah hasil ujian stage 3", http.StatusOK, gin.H{
		"stage_3": model.UpdateStage13try2Response{
			...
			Try2: model.Stage13Try{
				Status:     string(newStage3.Try2Status),
				No1:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No1),
				No2:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No2),
				No3:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No3),
				No4:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No4),
				No5:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No5),
				No6:        util.Stage123DatabaseNumbersToStruct(newStage3.Try2No6),
				Checkmarks: util.CheckmarksToBoolArray(newStage3.Try2Checkmarks),
			},
