	...
	return util.ToWebServiceResponse("Berhasil mengubah hasil ujian stage 1", http.StatusOK, gin.H{
		"stage_1": model.UpdateStage13Response{
			...
			Try2: model.Stage13Try{
				...
				No1:        util.NumbersToIntArrayArray(newStage1.Try2No1),
				No2:        util.NumbersToIntArrayArray(newStage1.Try2No2),
				No3:        util.NumbersToIntArrayArray(newStage1.Try2No3),
				No4:        util.NumbersToIntArrayArray(newStage1.Try2No4),
				No5:        util.NumbersToIntArrayArray(newStage1.Try2No5),
